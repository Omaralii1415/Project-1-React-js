        ...
        <Container>
          ...
          <Row className="align-items-center">
            <Col md={6} sm={12} className="wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              <div>
                <p><span>Email:</span> omaralii1415@gmail.com</p>
                <p><span>Phone:</span> 01025783827</p>
                <p><span>Address:</span> 22 omar ibn elkhattab-street</p>
              </div>
            </Col>
